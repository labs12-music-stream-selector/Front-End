...
export default function TermsOfService() {
  ...
  return (
    <div>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, MoodyBeats and/or it's licensors own the
        intellectual property rights for all material on MoodyBeats. All
        intellectual property rights are reserved. You may view and/or print
        pages from https://moodybeats.netlify.com for your own personal use
        subject to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://moodybeats.netlify.com</li>
        <li>
          Sell, rent or sub-license material from https://moodybeats.netlify.com
        </li>
        <li>
      ...
      <p>
        Redistribute content from MoodyBeats (unless content is specifically
        ...
        <li>
          ...
          <ol>
            <li>
              ...
              as Chambers ofcolor:"inherit",textDecoration:"none";cursor:"text"
      ...
      <p>
        ...
        MoodyBeats; and (d) where the link is in the context of general resource
      ...
      <p>
        No use of MoodyBeats's logo or other artwork will be allowed for linking
